---
title: "Qualtrics LEQ Output Cleaning Script"
...
if("wide_detailed" %in% data_type) {
  leq_data_clean_wide %>% write_csv(here(paste0(output_var, lubridate::today(), "wide_detailed_leq.csv")))
}

#-----------------------------------------Summary Data

if("wide_summary" %in% data_type) {
  leq_data_clean_wide_summary %>% write_csv(here(paste0(output_var, lubridate::today(), "wide_summary_leq.csv")))
}

#-----------------------------------------Long Data

if("long" %in% data_type) {
  leq_data_clean_long_detailed %>% write_csv(here(paste0(output_var, lubridate::today(), "long_leq.csv")))
}
