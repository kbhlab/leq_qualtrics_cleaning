...
Press the play button on the right-hand-side **after updating the variables and copying the entire code chunk to your project** to clean and save the LEQ data in your desired output. Your input file MUST be the full Qualtrics LEQ download as a CSV for this script to work.
