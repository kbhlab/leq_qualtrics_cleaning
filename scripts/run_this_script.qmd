...
```{r}
#---------------------INPUT DATA
input_var <- "data/2023-04-26_leq_data_REALDATA" #change this file path to match where your data is located and the file name WITHOUT the file extension. This is the data exported from the LEQ on Qualtrics as a CSV file.
...
check_discrepancies <- FALSE #do you want to check double entry of paper LEQ forms into Qualtrics for discrepancies? If so, change this variable to TRUE and the script will output a file called "discrepancies_to_check.csv" for specific data points to verify.
